...
const router = createBrowserRouter([
  ...
  { path: '/soundscapes', element: <ProtectedRoute><Soundscapes /></ProtectedRoute> },
  {
    path: '/crises-support',
    element: <CrisesSupport />,
    children: [
  ...
  },
  {
    ...
    children: [
      { index: true,           element: <PreferencesContent /> },
      { path: 'notifications', element: <h2 style={{color:'var(--text-primary)',fontFamily:'Sora,sans-serif',padding:'20px'}}>Notifications Coming Soon!</h2> },
      { path: 'privacy',       element: <h2 style={{color:'var(--text-primary)',fontFamily:'Sora,sans-serif',padding:'20px'}}>Privacy Coming Soon!</h2> },
      { path: 'about',         element: <AboutContent /> },
    ]
  },
  {
